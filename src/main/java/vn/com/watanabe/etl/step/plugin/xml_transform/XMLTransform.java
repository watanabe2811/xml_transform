...
public class XMLTransform extends BaseStep implements StepInterface {
   ...
   */
  public XMLTransform( StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis ) {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    ...
    XMLTransformMetaData meta = (XMLTransformMetaData) smi;
    XMLTranformData data = (XMLTranformData) sdi;
